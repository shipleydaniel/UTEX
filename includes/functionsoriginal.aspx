...
str = str + "                    </td></tr>" & vbCrLf  
str = str + "                    <tr><td class='subMenuExpandHover'>" & vbCrLf  
str = str + "                      <a href='orderingPricingShipping.aspx' class='menuItem' >Pricing and Preparation of Shipment</a>" & vbCrLf  
str = str + "                    </td></tr>" & vbCrLf  
str = str + " 			 <tr><td class='subMenuExpandHover'>" & vbCrLf
str = str + " 			   <a href='orderingShippingReplacement.aspx' class='menuItem' >Shipping and Replacement Policies</a>" & vbCrLf
str = str + " 			 </td></tr>" & vbCrLf
...
str = str + print_navigation_item ("Workshops", "Workshops.aspx") 
...
str = str + print_navigation_item ("<img src='images/new.gif' border=0> Genomic DNA", "GenomicDNA.aspx")
