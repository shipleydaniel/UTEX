...
<script language="VB" runat="server">
	...
	Sub btnRunQuery_OnClick(Sender As Object, E As EventArgs)
		...
		strSQLQuery = "SELECT details, utexPrefix + utexNumber as UtexNumber, genus, class, species, media, authoirityName FROM qry_searchList " & _
			"WHERE (algaeID " & rblLTorGT.SelectedItem.Value.ToString() & " " & txtSalesAmount.Text.ToString() & ") " & _
...
<form action="database.aspx" method="post" runat="server">
	...
	<asp:DropDownList id="ddlSortBy" runat="server">
		<asp:ListItem value="algaeid"         >AlgaeId</asp:ListItem>
